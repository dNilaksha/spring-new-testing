...
public class StockControllerTest {
	...
	@Test
    public void testStockConntrollerIsOk() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/stock/openstock").
    ...
    public void testLoyaltyCardGetStatusIsNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/stock/openstocks").
        		contentType(MediaType.APPLICATION_JSON))
    ...
    public void stockControllerPostStatusIsOk() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/stock/openstock")
        		.contentType(MediaType.APPLICATION_JSON)
        		.content(s))
                .andExpect(MockMvcResultMatchers.status().isOk());
